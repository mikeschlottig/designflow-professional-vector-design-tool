...
export function PropertiesPanel() {
  ...
  return (
    <div className="w-72 border-l border-border bg-background p-4 h-full overflow-y-auto space-y-6">
      ...
      {isSingle && (
        <>
          <div className="space-y-4">
            <h3 className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Layout</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Style</h3>
        <div className="space-y-3">
      ...
      <div className="pt-4 opacity-50 text-center">
        <p className="text-[10px] text-muted-foreground">Pro Tip: Use Shift + Click for multi-selection</p>
      </div>
    </div>
  );
}