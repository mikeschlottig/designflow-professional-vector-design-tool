    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-8 md:py-10 lg:py-12 flex flex-col gap-12">
          ...
          <section className="bg-zinc-900/50 border border-zinc-800 rounded-3xl p-8 md:p-12 relative overflow-hidden">
            <div className="relative z-10 max-w-2xl space-y-6">
              ...
              <div className="flex items-center gap-4 pt-4">
                <Button 
                  ...
                  disabled={isCreating}
                  size="lg" 
                  className="bg-blue-600 hover:bg-blue-700 text-white gap-2 h-12 px-6 rounded-xl"
                >
          ...
          <section className="space-y-6">
            ...
            {isLoading ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3].map(i => <div key={i} className="aspect-video bg-zinc-900 animate-pulse rounded-xl border border-zinc-800" />)}
              </div>
            ) : designs.length === 0 ? (
                  ...
                  <Link key={design.id} to={`/editor/${design.id}`}>
                    <Card className="bg-zinc-900 border-zinc-800 hover:border-zinc-600 transition-all cursor-pointer group">
                      <CardContent className="p-0">
                        <div className="aspect-video bg-zinc-800 rounded-t-xl overflow-hidden relative flex items-center justify-center">
                        ...
                        <div className="p-4 flex items-center justify-between">
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-zinc-500">{formatDistanceToNow(design.updatedAt)} ago</p>
                          </div>
                          <Button 
                            variant="ghost" 
                            size="icon" 
